            ...
            <Container className={classes.root}>
                ...
                <ButtonComponent onClick={onClick}>End quiz</ButtonComponent>
                    ...
                    container>
                        ...
                        <Grid item xs={3}>
                            <Typography variant="h4" component="h2">{participants[1].id.toUpperCase()}</Typography>
                            <Box className={`${classes.second} + ${classes.podium}`}></Box>               
                        </Grid>
                        }
                        <Grid item xs={3}>
                            <Typography variant="h4" component="h2">{participants[0].id.toUpperCase()}</Typography>
                            <Box className={`${classes.first} + ${classes.podium}`}></Box>                
                        </Grid>
                        {participants.length > 2 && <Grid item xs={3}>
                            <Typography variant="h4" component="h2">{participants[2].id.toUpperCase()}</Typography>
